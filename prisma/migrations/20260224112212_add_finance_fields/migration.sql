...
INSERT INTO "new_purchase_orders" ("client_id", "client_po_number", "created_at", "created_by", "delivery_deadline", "id", "is_paid", "is_urgent", "notes", "paid_at", "po_date", "po_number", "status") SELECT "client_id", "client_po_number", "created_at", "created_by", "delivery_deadline", "id", "is_paid", "is_urgent", "notes", "paid_at", "po_date", "po_number", "status" FROM "purchase_orders";
